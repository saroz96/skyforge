                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            <div className="left wrap-text">
                                ...
                                <div><strong>Address:</strong> {billData.bill.account?.address || 'N/A'}</div>
                                <div><strong>PAN:</strong> {billData.bill.account?.pan || 'N/A'} | <strong>Tel:</strong> {billData.bill.account?.phone || 'N/A'}</div>
                                <div><strong>Email:</strong> {billData.bill.account?.email || 'N/A'}</div>
                            </div>
                            <div className="right">
