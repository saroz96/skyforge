                                ...
                                <input
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'ArrowDown' || e.key === 'ArrowUp') {
                                            ...
                                            } else if (accountSearchQuery.trim()) {
                                                // Use typed text as new account
                                                // Assuming you have access to setFormData or similar function
                                                // If not, you'll need to pass it as a prop or use context
                                                // For now, I'll show a generic solution
                                                console.log('Using typed account name:', accountSearchQuery);
                                                // You would call something like:
                                                // handleTypedAccountName(accountSearchQuery);
                                                // handleAccountModalClose();
                                                // setTimeout(() => {
                                                //     document.getElementById('cashAccountAddress').focus();
                                                // }, 0);
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                if (accountSearchQuery.trim()) {
                                                    // Handle using typed account name
                                                    console.log('Using typed account name:', accountSearchQuery);
                                                    // You would call something like:
                                                    // handleTypedAccountName(accountSearchQuery);
                                                    // handleAccountModalClose();
