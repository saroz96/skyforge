...
const SalesBillsList = () => {
    ...
    const TableRow = React.memo(({ index, style, data: rowData }) => {
        ...
        const handleDoubleClick = () => {
            navigate(`/retailer/sales/${bill._id}/print`);
        };
        ...
        const handleEditClick = (e) => {
            e.stopPropagation();
            if (bill.account?._id) {
                navigate(`/retailer/credit-sales/edit/${bill._id}`);
            } else if (bill.cashAccount) {
                navigate(`/retailer/cash-sales/edit/${bill._id}`);
            }
        };
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    {(bill.account?._id || bill.cashAccount) && (
                        <button
