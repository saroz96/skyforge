...
//                     handleBack(); // Navigate back after successful print
//                 } catch (printError) {
...
//                         type: 'warning'
//                     });
//                     handleBack(); // Still navigate back even if print fails
//                 }
//             } else {
//                 handleBack(); // Navigate back if no print was requested
//             }
        ...
        const fetchReceiptData = async () => {
            try {
                ...
                if (data.success) {
                    const receiptData = data.data.receipt;
                    const receiptDate = receiptData.date ? new Date(receiptData.date).toISOString().split('T')[0] : new Date().toISOString().split('T')[0];
                    const nepaliDate = receiptData.date || currentNepaliDate;
                                        ...
                                        <div className="col-12 col-md-6 col-lg-2">
                                            <div className="position-relative">
                                                <input
                                                    ...
                                                    name="nepaliDate"
                                                    id="nepaliDate"
                                                    ref={companyDateFormat === 'nepali' ? transactionDateRef : null}
                                                    autoComplete='off'
                                        ...
                                        <div className="col-12 col-md-6 col-lg-2">
                                            <div className="position-relative">
                                                <input
                                                    ...
                                                    id="billDate"
                                                    className="form-control form-control-sm"
                                                    ref={companyDateFormat === 'english' ? transactionDateRef : null}
                                                    value={formData.billDate}
                                                    onChange={(e) => {
                                                        const value = e.target.value;
